# edited by darkou for Advanced-Spotify-Statistics
...
class Banner:
    ...
    def Lines(content: str, colored = False, color = None, mode = Colorate.Horizontal, line = '═', pepite = 'ቐ') -> str:
        l = 1
        ...
        if colored:
            return f"{Fore.GREEN}" + final + f"{Style.RESET_ALL}"
        else:
            return final
